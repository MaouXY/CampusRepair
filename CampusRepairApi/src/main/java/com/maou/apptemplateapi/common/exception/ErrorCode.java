...
public enum ErrorCode {
    ...
    RAG_EVAL_DATASET_EMPTY(31001, "rag evaluation dataset is empty"),
    RAG_EVAL_CASE_INVALID(31002, "rag evaluation case invalid"),
    RAG_EVAL_RUN_NOT_FOUND(31003, "rag evaluation run not found"),
    RAG_EVAL_IMPORT_INVALID(31004, "rag evaluation import content invalid"),
